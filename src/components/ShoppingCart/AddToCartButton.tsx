...
export default function AddToCartButton({ onAddCart }: AddtoCart) {
  return (
    <button
      className="flex w-full h-12 justify-center items-center bg-orange text-white rounded-md hover:opacity-70 md:w-[170%] transition-all duration-[125ms] ease-in-out"
      onClick={onAddCart}
    >
